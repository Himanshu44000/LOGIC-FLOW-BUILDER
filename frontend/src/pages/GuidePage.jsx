...
export default function GuidePage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-slate-100 to-slate-50 dark:from-slate-900 dark:to-slate-800 px-4 py-8 text-slate-900 dark:text-slate-100">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="space-y-8">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-lg dark:border-slate-700 dark:bg-slate-900">
            ...
            <ol className="space-y-4">
              <li className="flex gap-4">
                <span className="shrink-0 w-8 h-8 rounded-full bg-cyan-600 text-white flex items-center justify-center font-bold">1</span>
                <div>
              ...
              <li className="flex gap-4">
                <span className="shrink-0 w-8 h-8 rounded-full bg-cyan-600 text-white flex items-center justify-center font-bold">2</span>
                <div>
              ...
              <li className="flex gap-4">
                <span className="shrink-0 w-8 h-8 rounded-full bg-cyan-600 text-white flex items-center justify-center font-bold">3</span>
                <div>
              ...
              <li className="flex gap-4">
                <span className="shrink-0 w-8 h-8 rounded-full bg-cyan-600 text-white flex items-center justify-center font-bold">4</span>
                <div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-lg dark:border-slate-700 dark:bg-slate-900">
            ...
            <ol className="space-y-4">
              <li className="flex gap-4">
                <span className="shrink-0 w-8 h-8 rounded-full bg-emerald-600 text-white flex items-center justify-center font-bold">1</span>
                <div>
              ...
              <li className="flex gap-4">
                <span className="shrink-0 w-8 h-8 rounded-full bg-emerald-600 text-white flex items-center justify-center font-bold">2</span>
                <div>
              ...
              <li className="flex gap-4">
                <span className="shrink-0 w-8 h-8 rounded-full bg-emerald-600 text-white flex items-center justify-center font-bold">3</span>
                <div>
              ...
              <li className="flex gap-4">
                <span className="shrink-0 w-8 h-8 rounded-full bg-emerald-600 text-white flex items-center justify-center font-bold">4</span>
                <div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-lg dark:border-slate-700 dark:bg-slate-900">
            ...
            <ol className="space-y-3">
              <li className="flex gap-4">
                <span className="shrink-0 w-8 h-8 rounded-full bg-orange-500 text-white flex items-center justify-center font-bold">1</span>
                <div>
              ...
              <li className="flex gap-4">
                <span className="shrink-0 w-8 h-8 rounded-full bg-orange-500 text-white flex items-center justify-center font-bold">2</span>
                <div>
                  <p className="font-semibold text-slate-900 dark:text-slate-100">Run or Debug Run</p>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Click <strong>Run</strong> to execute normally. If you've placed breakpoints (dots) they will be respected during execution and pause the flow at those nodes.</p>
                </div>
              </li>

              <li className="flex gap-4">
                <span className="shrink-0 w-8 h-8 rounded-full bg-orange-500 text-white flex items-center justify-center font-bold">3</span>
                <div>
              ...
              <li className="flex gap-4">
                <span className="shrink-0 w-8 h-8 rounded-full bg-orange-500 text-white flex items-center justify-center font-bold">4</span>
                <div>
            ...
            <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg dark:bg-yellow-900/20 dark:border-yellow-700">
              <p className="text-sm text-yellow-900 dark:text-yellow-200">Note: Breakpoints are saved with the flow when you save or autosave it. Additionally, a local "last-used" breakpoint memory is kept and will be applied when you press Debug Run if you have no active breakpoints. Long-running API nodes pause only at the next node boundary.</p>
            </div>

            <div className="mt-6 rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800/60">
              <p className="mb-3 font-semibold text-slate-900 dark:text-slate-100">Keyboard shortcuts</p>
              <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-300">
                <li><strong>F5</strong> - Run / Stop</li>
                <li><strong>F8</strong> - Continue</li>
                <li><strong>F10</strong> - Step</li>
                <li><strong>F9</strong> - Toggle breakpoint on selected node</li>
              </ul>
            </div>

            <div className="mt-4 rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800/60">
              <p className="mb-3 font-semibold text-slate-900 dark:text-slate-100">Watch expressions</p>
              <p className="text-sm text-slate-600 dark:text-slate-300">
                Add dot-path expressions like <strong>user.name</strong> or <strong>items[0].price</strong> to track specific values from the live variables panel while the flow runs or pauses.
              </p>

              <div className="mt-3">
                <p className="font-semibold text-sm text-slate-900 dark:text-slate-100">How to add a watch</p>
                <ol className="mt-2 list-decimal pl-5 text-sm text-slate-600 dark:text-slate-300 space-y-1">
                  <li>Type the path in the Watch panel input and press <strong>Add</strong> (or press Enter).</li>
                  <li>Use <strong>Suggest Watches</strong> to auto-populate likely paths discovered in node fields (variableName, saveTo, target, counters, and moustache templates like <code>{'{{ user.email }}'}</code>).</li>
                  <li>Remove any unwanted watches with the trash icon — watches are saved per-flow automatically.</li>
                </ol>
              </div>

              <div className="mt-3 text-sm text-slate-600 dark:text-slate-300">
                <p className="font-semibold">Path rules & safety</p>
                <p className="mt-1">Paths are resolved safely using dot/bracket lookup only (no eval). Examples: <code>sum</code>, <code>user.name</code>, <code>items[0].price</code>. If a path is missing in the current snapshot it will show <strong>undefined</strong>.</p>
              </div>

              <div className="mt-3 text-sm text-slate-600 dark:text-slate-300">
                <p className="font-semibold">Persistence & keys</p>
                <p className="mt-1">Watches are stored per flow in localStorage under the key <code>lfb:watches:&lt;flowId&gt;</code>. Unsaved flows use <code>lfb:watches:unsaved</code>.</p>
              </div>

              <div className="mt-3 text-sm text-slate-600 dark:text-slate-300">
                <p className="font-semibold">Change highlighting</p>
                <p className="mt-1">When execution pauses or you step, watches whose formatted value changed since the last snapshot briefly highlight in green and get a "changed" badge. The highlight clears automatically after 2 seconds — this helps you spot variable changes quickly.</p>
              </div>
            </div>
          </div>
