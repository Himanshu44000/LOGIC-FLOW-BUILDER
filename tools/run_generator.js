...
for (const lang of languages) {
  try {
    ...
    results[lang] = { code: out.code, warnings: out.warnings }
  } catch (err) {
    results[lang] = { error: String(err) }
  }
}

fs.writeFileSync('generated_outputs.json', JSON.stringify(results, null, 2), 'utf8')
console.log('Wrote generated_outputs.json')
